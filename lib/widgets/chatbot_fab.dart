...
// 1. IMPORTAMOS TU LLAVE SEGURA (Esto evita que se filtre en Git)
        ...
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setModalState) {
            ...
            Future<void> _sendMessage() async {
              ...
              // 2. USAMOS LA VARIABLE SEGURA (Sin escribir la clave real aquí)
              const apiKey = googleApiKey;
              
              // 3. RESTAURAMOS TU URL PREFERIDA (Versión 2.5)
              final url = Uri.parse(
              ...
              try {
                ...
                if (response.statusCode == 200) {
                  ...
                  final data = json.decode(response.body);
                  print("ERROR CONSOLA GOOGLE: $data"); // Para depurar si falla
                  setModalState(() {
                    messages.removeLast();
                    // Si falla, mostramos el código para saber qué pasó
                    messages.add(ChatMessage("Error del servidor (${response.statusCode})."));
                  });
                }
              } catch (e) {
                setModalState(() {
                  messages.removeLast();
                  messages.add(ChatMessage("Error de conexión."));
                });
              }
            }
                                    ...
                                    title: Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: msg.text == "..."
                                          ...
                                          : MarkdownBody(
                                              data: msg.text,
                                              styleSheet: MarkdownStyleSheet(p: TextStyle(color: msg.isUser ? Colors.white : Theme.of(context).colorScheme.onSurfaceVariant)),
                                            ),
                                      ),
                                    ),
                                  );
